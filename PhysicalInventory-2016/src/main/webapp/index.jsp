  ...
  <body ng-app="inventoryApp">
   ...
   <!--  <nav id="myNavbar" class="navbar navbar-default navbar-inverse navbar-fixed-top" role="navigation"> -->
    ...
    <div class="container-fluid">
         <div class="navbar-blue text-center clearfix"style="background-color: #005BB2 !important">
        ...
        <div class="text-center clearfix" id="navbarCollapse">
             <ul class="nav navbar-nav" style="margin-top:-1% !important;margin-bottom:-1% !important;">
              <li id="dashboardLi" style="padding-top: 13px;padding-bottom: 13px;"><a ui-sref="dashboard" style="font-size:18px">Dashboard</a></li>
...
<div class="container-fluid">
    <div ui-view="" style="width:100%;align:right;"></div>
        ...
        <div class="footer container">
                ...
                &copy; Copyright &copy; Sherwin Williams
...
<script>
    ...
    <script type="text/javascript" src="bower_components/jspdf/libs/sprintf.js"></script>
    <script type="text/javascript" src="bower_components/jspdf/jspdf.js"></script>
    <script type="text/javascript" src="bower_components/jspdf/libs/base64.js"></script>
