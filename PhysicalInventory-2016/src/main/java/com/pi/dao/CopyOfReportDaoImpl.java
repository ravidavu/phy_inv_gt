...
//public class CopyOfReportDaoImpl implements ReportDao {
//
//	ResultSet rst = null;
//	@Autowired
...
//			floorList.add(formatNumber(floorRs.getString("CURRENT_YEAR_OBS")));
//			floorList.add(formatNumber(floorRs
...
//			sparyList.add(formatNumber(sparyRS
//					.getString("TY_INV_SHRINK_TO_SLS")));
//			sparyList.add(formatNumber(sparyRS.getString("CURRENT_YEAR_OBS")));
//			sparyList.add(formatNumber(sparyRS
//					.getString("CURRENT_YEAR_OBS_ADJ")));
//			sparyList.add(formatNumber(sparyRS
//					.getString("ADJ_CURRENT_YEAR_OBS")));
...
//			paintList.add(formatNumber(paintRS
//					.getString("TY_INV_SHRINK_TO_SLS")));
//			paintList.add(formatNumber(paintRS.getString("CURRENT_YEAR_OBS")));
//			paintList.add(formatNumber(paintRS
//					.getString("CURRENT_YEAR_OBS_ADJ")));
//			paintList.add(formatNumber(paintRS
//					.getString("ADJ_CURRENT_YEAR_OBS")));
