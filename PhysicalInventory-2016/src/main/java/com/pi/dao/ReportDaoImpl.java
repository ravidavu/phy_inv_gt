...
public class ReportDaoImpl implements ReportDao {
	...
	public Map<String, List<String>> getReport(int storeId) {
		...
		while (paintRS.next()) {
			...
			paintList.add(paintRS.getString("CURRENT_YEAR_OBS"));
		...
		while (brushRollerRS.next()) {
			...
			brushRollerList.add(brushRollerRS
			...
			brushRollerList
					.add(brushRollerRS.getString("Z_OPEN_MON_SALES_RPT"));
			...
			brushRollerList
					.add(brushRollerRS.getString("TY_INV_SHRINK_3710_A"));
			brushRollerList
					.add(brushRollerRS.getString("TY_INV_SHRINK_TO_SLS"));
			brushRollerList
			.add(brushRollerRS.getString("CURRENT_YEAR_OBS"));
			brushRollerList
					.add(brushRollerRS.getString("CURRENT_YEAR_OBS_ADJ"));
			brushRollerList
					.add(brushRollerRS.getString("ADJ_CURRENT_YEAR_OBS"));
			brushRollerList.add(brushRollerRS
		...
		while (assocProdcutsRS.next()) {
			...
			assocProdcutsList.add(assocProdcutsRS
					.getString("A_CHRGD_TO_STR_NOT_RECVD_INT"));
			assocProdcutsList.add(assocProdcutsRS
					.getString("B_RECVD_NOT_CHRGD_TO_STR_EXT"));
			assocProdcutsList.add(assocProdcutsRS
		...
		while (floorRs.next()) {
			...
			floorList.add(floorRs.getString("CURRENT_YEAR_OBS"));
		...
		while (sparyRS.next()) {
			...
			sparyList.add(sparyRS.getString("CURRENT_YEAR_OBS"));
		...
		while (wallCoveringRS.next()) {
			...
			wallCoveringList.add(wallCoveringRS
					.getString("A_CHRGD_TO_STR_NOT_RECVD_INT"));
			wallCoveringList.add(wallCoveringRS
					.getString("B_RECVD_NOT_CHRGD_TO_STR_EXT"));
			wallCoveringList.add(wallCoveringRS
		...
		while (windowTreatRS.next()) {
			...
			windowTreatList.add(windowTreatRS
					.getString("A_CHRGD_TO_STR_NOT_RECVD_INT"));
			windowTreatList.add(windowTreatRS
					.getString("B_RECVD_NOT_CHRGD_TO_STR_EXT"));
			windowTreatList.add(windowTreatRS
			...
			windowTreatList.add(windowTreatRS
					.getString("R_OPEN_DISCREPANCY_RPT_EXT"));
			windowTreatList
					.add(windowTreatRS.getString("Z_OPEN_MON_SALES_RPT"));
			...
			windowTreatList
					.add(windowTreatRS.getString("TY_INV_SHRINK_3710_A"));
			windowTreatList
					.add(windowTreatRS.getString("TY_INV_SHRINK_TO_SLS"));
			windowTreatList
			.add(windowTreatRS.getString("CURRENT_YEAR_OBS"));
			windowTreatList
					.add(windowTreatRS.getString("CURRENT_YEAR_OBS_ADJ"));
			windowTreatList
					.add(windowTreatRS.getString("ADJ_CURRENT_YEAR_OBS"));
			windowTreatList.add(windowTreatRS
					.getString("ADJ_CURRENT_YEAR_OBS_PERCENT"));
